...
exports.update = function(req, res) {
  ...
  var ministry_Name = req.body.ministry_Name; // First name of user.
  var ministry_Email_Address = req.body.ministry_email_address; 
  var ministry_Contact = req.body.ministry_Contact;
      
  ministry.findById(id, function(err, doc) {
      if(!err && doc) {
        doc.ministryName = ministry_Name;
        doc.ministryEmailAddress = user_last_name;
        doc.ministryContact = user_email_address;
